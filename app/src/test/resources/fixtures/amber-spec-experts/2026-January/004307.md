...
statement_](/rendered/amber-spec-experts/2026-January/004306.html) feature.
...
help you give up would be proportional to the degree of deviation from the record ideal.
...
has made the representation choice to internally store `s` as a nullable `String`.
...
representation; the class author has to declare that just as with any other class.
