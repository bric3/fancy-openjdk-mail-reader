...
> To: "Remi Forax" <[forax at univ-mlv.fr](https://mail.openjdk.org/mailman/listinfo/amber-spec-experts)>, "Brian Goetz" <[brian.goetz at oracle.com](https://mail.openjdk.org/mailman/listinfo/amber-spec-experts)>
...
It can work as you said for a concrete type, but for an abstract type, you need to go from the abstract definition to the concrete one,
